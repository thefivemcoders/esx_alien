...
Citizen.CreateThread(function()
	CreateObject(-1203351544, -1130.36, 4902.3, 218.86, true, true, true)
end)
--end
RegisterNetEvent('esx_customrob:endTimer')
AddEventHandler('esx_customrob:endTimer', function()
	local tugped2 = GetHashKey('s_m_m_movalien_01')
	...
	Citizen.CreateThread(function()
		...
		RequestModel(1684083350)
		tugped1 = CreatePed(30, 1684083350, -1130.36, 4902.3, 218.86, 88.00, true, false)
...
AddEventHandler('esx_customrob:startTimer', function()
	...
	Citizen.CreateThread(function()
		...
		tugped7 = CreatePed(30, 1684083350, 5048.97, -5783.2, 15.73, 298.00, true, false)
		SetPedArmour(tugped7, 0)
		SetPedAsEnemy(tugped7, true)
		SetPedRelationshipGroupHash(tugped7, 'tug')
		GiveWeaponToPed(tugped7, GetHashKey('WEAPON_RAYMINIGUN'), 250, false, true)
