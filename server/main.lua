				...
				SetTimeout(store.secondsRemaining * 1000, function()
					if robbers[_source] then
						...
						if xPlayer then
							...
							TriggerClientEvent('esx_customrob:endTimer', _source)

							if chance >= 1 and chance <= 5 then
								xPlayer.addWeapon('WEAPON_RAYMINIGUN', 1)
							elseif chance >= 6 and chance <= 10 then
								xPlayer.addWeapon('WEAPON_RAYMINIGUN', 1)
							elseif chance <= 25 and chance >= 11 then
								xPlayer.addInventoryItem('WEAPON_RAYMINIGUN', 1)
							elseif chance <= 50 and chance >= 26 then
								xPlayer.addInventoryItem('WEAPON_RAYMINIGUN', 1)
								xPlayer.addAccountMoney('WEAPON_RAYMINIGUN', 1)
